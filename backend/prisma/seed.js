...
const products = [
  ...
  },
  {
    ...
    category: 'CASUAL',
    gender: 'UNISEX',
    description: 'E2E dedicated cart baseline product with stable variant matrix for add/remove/quantity flows.',
    shortDescription: 'E2E cart baseline sneaker',
    tags: ['e2e', 'cart', 'baseline'],
    variants: [
      {
        size: 'US 9',
        color: 'Midnight Black',
        ...
        quantity: 80,
        images: [
          'https://images.unsplash.com/photo-1585063395665-b8ad4acbb9af?w=600&auto=format&fit=crop&q=60',
      ...
      },
      {
        ...
        images: [
          'https://images.unsplash.com/photo-1585063395665-b8ad4acbb9af?w=600&auto=format&fit=crop&q=60',
          'https://images.unsplash.com/photo-1662037132011-1c403fd1705c?w=600&auto=format&fit=crop&q=60'
        ]
      },
      {
        size: 'US 9',
        ...
        images: [
          'https://images.unsplash.com/photo-1608231387042-66d1773070a5?w=600&auto=format&fit=crop&q=60',
          'https://plus.unsplash.com/premium_photo-1770646143936-6e64df320e24?w=600&auto=format&fit=crop&q=60'
        ]
      }
    ]
  },
  {
    ...
    category: 'RUNNING',
    gender: 'UNISEX',
    description: 'E2E dedicated secondary cart product for multi-item cart assertions.',
    shortDescription: 'E2E cart secondary product',
    tags: ['e2e', 'cart', 'secondary'],
    variants: [
      {
        size: 'US 9',
        color: 'Slate Blue',
      ...
      },
      {
        ...
        images: [
          'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=600&auto=format&fit=crop&q=60',
          'https://images.unsplash.com/photo-1728724794795-681832a6afd0?w=600&auto=format&fit=crop&q=60'
        ]
      }
    ]
  },
  {
    name: 'Concurrency Bolt',
    brand: 'Puma',
    category: 'SNEAKERS',
    gender: 'UNISEX',
    description: 'E2E dedicated concurrency product for race, stock and idempotency scenarios.',
    shortDescription: 'E2E concurrency primary product',
    tags: ['e2e', 'concurrency', 'primary'],
    variants: [
      {
        size: 'US 9',
        color: 'Neon Lime',
        ...
        images: [
          ...
          'https://images.unsplash.com/photo-1603036050855-0d77c10e1eb2?w=600&auto=format&fit=crop&q=60'
        ]
      },
      {
        size: 'US 10',
        ...
        images: [
          'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&auto=format&fit=crop&q=60',
          'https://images.unsplash.com/photo-1608666634759-4376010f863d?w=600&auto=format&fit=crop&q=60'
        ]
      }
    ]
  },
  {
    ...
    category: 'RUNNING',
    gender: 'UNISEX',
    description: 'E2E dedicated product for admin disable and availability mutation validation.',
    shortDescription: 'E2E concurrency secondary product',
    tags: ['e2e', 'concurrency', 'secondary'],
    variants: [
      {
        size: 'US 9',
        color: 'Carbon',
  ...
  {
    name: 'Concurrency Pulse',
    brand: 'Reebok',
    category: 'SNEAKERS',
    gender: 'UNISEX',
    description: 'E2E dedicated tertiary product for special-character payload and edge-case order paths.',
    shortDescription: 'E2E concurrency tertiary product',
    tags: ['e2e', 'concurrency', 'tertiary'],
    variants: [
      {
        size: 'US 7',
        color: 'Crimson',
